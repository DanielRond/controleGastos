...
src/controlegastos/
  ...
  generator.py       # gera .xlsx com openpyxl (Resumo Geral + abas por mês + Gráficos)
docs/media/          # capturas da planilha usadas no README
...
- **Gráficos**: pizza por classe de investimento e barras mensais (receitas, despesas, investimentos e saldo livre), alimentados por uma área de apoio.
